...
function Home() {
  return (
    <div className="bg-black w-full">
      <div className=" py-10  container"></div>
      <div className=" mx-auto max-w-7xl border-t border-gray-600 mt-10  font-serif  ">
        <div className="border-b border-gray-600 mb-5">
          <div className="grid max-w-lg gap-8 mx-auto  lg:grid-cols-2 lg:max-w-none   ">
            <div className="flex flex-col  overflow-hidden ">
              ...
              <div className="flex flex-col justify-center flex-1">
                <div className="flex-1">
                  ...
                  <p className="block mt-2 space-y-2 ml-64">
                    ...
                    <h2 className=" text-center py-2 text-2xl font-serif  leading-none  text-white">
                      Doers School
                    </h2>
                  </p>
                  <BsFillCircleFill
              ...
              <div className="flex flex-col overflow-hidden items-center sm:ml-0 sm:pl-0  -mb-1 ">
                <div className="flex flex-col justify-between flex-1">
                  <div className="flex-1 -mt-16 absolute">
                    <div className="mt-0 text-gray-400">
                      <div className="px-2 py-1 scale-95 text-center flex flex-row  mb-10">
                        <div>
                          <BsHexagon
                            className="text-orange-500 absolute -mt-1"
                            size={200}
                          ></BsHexagon>
                          <div className="">
                            <h3 className="text-2xl font-semibold group-hover:text-black  text-orange-500 mx-10  py-16 px-2">
                              Ultimos
                              <br /> Lugares
                            </h3>
                          </div>
                    ...
                    <div className="mt-0 text-gray-400">
                      <div className="border border-gray-500 px-2 py-1 border-l-4 border-l-orange-500 rounded-sm group hover:bg-white hover:border-gray-100 hover:border-l-orange-700  duration-300 scale-95 hover:scale-100 ">
